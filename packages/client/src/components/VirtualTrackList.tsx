...
function TrackSkeleton() {
  return (
    <div className="flex min-w-0 max-w-full items-center gap-3 overflow-hidden px-3 py-2.5">
...
export const VirtualTrackList = forwardRef<VirtualTrackListRef, VirtualTrackListProps>(function VirtualTrackList(
  ...
  return (
    <div
      ...
      className={cn('min-h-0 min-w-0 max-w-full flex-1 overflow-x-hidden overflow-y-auto rounded-md border', className)}
    >
      <div
        style={{
