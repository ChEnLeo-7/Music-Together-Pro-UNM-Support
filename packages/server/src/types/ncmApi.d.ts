...
declare module '@neteasecloudmusicapienhanced/api' {
  ...
  interface NcmApiInstance {
    ...
    song_detail(params: { ids: string | number } & RequestBaseConfig): Promise<{
      body: {
        code?: number
    ...
    song_music_detail(params: { id: string | number } & RequestBaseConfig): Promise<{
      body: {
        code?: number
    ...
    song_url_v1(params: { id: string | number; level: NeteaseSoundQualityLevel } & RequestBaseConfig): Promise<{
      body: {
        code?: number
